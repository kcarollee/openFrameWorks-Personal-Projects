...
void ofApp::setup() {
	...
	howToGuide.load("verdana.ttf", 10);
	...
	howToBox.set(960, ofGetHeight() - 100, 200, 50);
}
...
void ofApp::draw() {
	...
	ofSetColor(0, 0, 0);
	howToGuide.drawString("1.Select the spaces that" 
		"correspond to a student's schedule\n2.Click \"Register\""
		"\n3.Do the same for all the students.\n"
		"4.Click \"See Results\" to see the time slots" 
		"in which none of the students\' schedule overlap.", ofGetWidth() - 100, 70);
	...
	ofSetColor(howToColor);
	ofDrawRectangle(howToBox);
	...
	ofSetColor(0, 0, 0);
	font.drawString("?", 980, ofGetHeight() - 70);
}
